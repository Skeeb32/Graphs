...
# the number of 1 islands. An island consist of 1s that are
...
#           [1, 0, 1, 0, 0],
#           [1, 1, 0, 0, 0]]
# island_counter(island) # returns 4

# island consist of - connected components
...
# Loop through all call a traversal if we find an unvisited 1
